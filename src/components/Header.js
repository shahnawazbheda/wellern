...
export default function Header() {
    return (
        <>
            <div className='bg-[#204ECF] flex md:flex-row flex-col'>
                <p className='text-white text-xl p-3 ms-5 md:block hidden'><i className="bi bi-clock"></i><span className='font-bold'> Working Hours :</span> Monday - Friday, 08am - 05pm</p>

                <div className='mt-4 md:mb-0 mb-5 text-xl text-gray-300 flex justify-center  ms-10 md:ms-[38%]'>
                    <p className='hover:text-white'><i className="bi bi-twitter"></i></p>
                    <p className='hover:text-white ms-5'><i className="bi bi-facebook"></i></p>
                    <p className='hover:text-white ms-5'><i className="bi bi-instagram"></i></p>
                    <p className='hover:text-white ms-5'><i className="bi bi-pinterest"></i></p>
                    
                        <p className='text-xl ms-5 md:block hidden '>|</p>
                        <a href='#' className='hover:text-green-300 hover:underline ms-5 md:block hidden'>Setting & Privacy</a>

                        <a href='#' className='hover:text-green-300 hover:underline ms-5 md:block hidden'>Faqs</a>
                        <a href='#' className='hover:text-green-300 hover:underline ms-5 md:block hidden'>About</a>
                    
                </div>
            </div>

            <nav className="bg-white bg-gray-100 dark:bg-gray-900 ">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between md:mx-32 p-4">
                    <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                        <img src="./assets/logo-three.png" alt="Flowbite Logo" />
                    </a>
                    <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                        <button type="button" data-dropdown-toggle="language-dropdown-menu" className=" md:block hidden inline-flex text-xl items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                        ...
                        <button className='bg-green-500 md:block hidden text-white font-medium py-3 rounded-md hover:bg-blue-700 px-10 '>Register    </button>
                        {/* Dropdown */}
                    ...
                    <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-language">
                        <ul className="flex flex-col text-xl font-bold p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>

                                <select className="block py-2 px-3 w-full text-black underline bg-blue-700 rounded md:bg-transparent  md:p-0 " >
                                    <option >Home</option>
                                    <option value="HomeOne">Home One</option>
                                    <option value="HomeTwo">Home Two</option>
                                    <option value="HomeThree">Home Three</option>
                                    <option value="HomeFour">Home Four</option>
                                </select>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <select className="block  py-2 px-3 w-full text-black  rounded md:bg-transparent  md:p-0 md:dark:text-blue-500" >
                                    <option className='underline'>Courses</option>
                                    <option value="CoursesGrid">Courses Grid</option>
                                    <option value="CoursesList">Courses List</option>
                                    <option value="CoursesTimeline">Courses Timeline</option>
                                    <option value="CoursesDetails">Courses Details</option>
                                </select>
                            </li>
                            <li>
                                <select className="block py-2 px-3 w-full text-black underline bg-blue-700 rounded md:bg-transparent  md:p-0 " >
                                    <option >Pages</option>
                                    <option value="HomeOne">FAQ`S</option>
                                    <option value="HomeTwo">Shop</option>
                                    <option value="HomeThree">industry</option>
                                    <option value="HomeFour">Gallary</option>
                                </select>
                            </li>
                            <li>
                                <select className="block py-2 px-3 w-full text-black underline bg-blue-700 rounded md:bg-transparent  md:p-0 " >
                                    <option >Blog</option>
                                    <option value="HomeOne">Blog Page</option>
                                    <option value="HomeTwo">Blog Details</option>
                                </select>
                            </li>
                        </ul>
                    </div>
